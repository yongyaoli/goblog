...
func Run(port int) error {
	...
	adminPages.Use(middleware.AdminPageAuth(secret))
	adminPages.GET("/dashboard", admin.DashboardPage)
	adminPages.GET("/posts/new", admin.PostEditPage)
	adminPages.GET("/posts/:id/edit", admin.PostEditPage)
	adminPages.GET("/categories", admin.CategoriesPage)
	adminPages.GET("/tags", admin.TagsPage)
	adminPages.GET("/series", admin.SeriesPage)
	adminPages.GET("/comments", admin.CommentsPage)
	adminPages.GET("/views", admin.ViewsPage)
	adminPages.GET("/audit", admin.AuditPage)
	adminPages.GET("/attachments", admin.AttachmentsPage)
	adminPages.GET("/attachment", admin.AttachmentsPage)
	adminPages.GET("/menus", admin.MenusPage)
	adminPages.GET("/redis", admin.RedisPage)
	adminPages.GET("/links", admin.LinksPage)
